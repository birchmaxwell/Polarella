...
genesOfInterest <- c("PTHR42704", "PTHR21649", "PTHR11002", "PTHR28286", 
                     "PTHR42715", "PTHR11177", "PTHR10353", "PTHR23516", "PTHR22762",
                     "PTHR31297", "PTHR12121", "PTHR47822", "PTHR33175", "PTHR11630",
                     ...
                     "PTHR11544", "PTHR43208", "PTHR11051", "PTHR11709", "PTHR11693")
commonName <- as.data.frame(c("RuBisCO", "Chl A/B Binding Protein", 
                              ...
                              "Alpha-Glucosidase (GH31)", "Endo-1,6-beta-glucanase (GH5)", "Carbon Catabolite Repressor P4",                
                              "Carbohydrate Binding Domain", "DNA-Binding Protein HU", "DNA Replicating - MCM",
                              ...
                              "ABC Transporter", "Glycosyl Hydrolase (GH65)",
                              "Auxiliary Activities 1", "ATP Synthase Gamma Subunit"))
...
transporters <- c("PTHR23515", "PTHR11730", "PTHR43029", "PTHR11814", "PTHR43310",
                  ...
                  "PTHR10464", "PTHR22950",  "PTHR23516", "PTHR43208", "PTHR48085")
...
heterotrophy <- c("PTHR38674", "PTHR11177", "PTHR10353", "PTHR11051", "PTHR31297",
                  "PTHR31263", "PTHR12121", "PTHR47822", "PTHR42715", "PTHR22762",
...
RPKM_combined_GeneGroup <- RPKM_combined %>%
  ...
  filter(!(type == "Potential Heterotrophy" & grepl("OvS", New_Name))) %>%
...
trans_order <- c("1026009", "778892",
                 ...
                 "2266959", "5374355", "2916846", "912361", 
...
heatmap <- ggplot(Heatmap, aes((Samp), fct_inorder(New_Name))) +
  ...
  facet_grid(factor(type, levels = c("Stress Response", "Transporters", "Potential Heterotrophy", "Phototrophy")) ~ Group,
  ...
  labs(x = "Sample")
ggsave("heatmap4.png", heatmap, height = 24, width = 18.5, units = "in")
...
Flur <- ggplot(oxygenFluorPar2) +
  ...
  labs(title = NULL, x = "Fluorescence (RFU)", y = NULL, colour = "Station") +
